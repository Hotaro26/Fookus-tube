...
2. Open the project in Android Studio or navigate to the project directory in your terminal.
3. Run the following command to build the debug APK:
   ./gradlew assembleDebug
4. To install it directly to a connected device or emulator, run:
...
3. Write your code and make sure the project builds successfully.
